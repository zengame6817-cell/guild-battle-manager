...
import { collection, doc, getFirestore, onSnapshot, serverTimestamp, setDoc } from "./firebase-sdk/firebase-firestore.js";
  ...
  window.GBM_FIREBASE_ATTENDANCE = {
    subscribe(mode) {
      ...
      unsubscribe = onSnapshot(collection(db, "attendance"), snapshot => {
        window.dispatchEvent(new CustomEvent("gbm-firebase-connected"));
